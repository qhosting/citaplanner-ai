  ...
  return (
    <div className="bg-card-theme rounded-[3rem] shadow-sm border border-theme p-10 mb-8 relative overflow-hidden group">
      ...
      <div className="flex items-center gap-5 mb-8">
        ...
        <div>
          <h2 className="text-2xl font-black text-main tracking-tighter">Agenda AI</h2>
          <p className="text-xs text-muted font-bold uppercase tracking-widest mt-1">Sincronización Natural con Aurum Ecosystem</p>
        </div>
      </div>
