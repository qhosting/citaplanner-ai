        ...
        <div className="max-w-7xl mx-auto px-6 py-16 animate-entrance">
                                        ...
                                        history.map(apt => (
                                            <tr key={apt.id} className="hover:bg-white/5 transition-colors group">
                                                ...
                                                <td className="px-12 py-8 text-center">
                                                    <span className={`text-[9px] font-black px-5 py-2 rounded-full uppercase tracking-widest ${apt.status === AppointmentStatus.COMPLETED ? 'text-[#D4AF37] border border-[#D4AF37]/30' :
            ...
            {settings?.contactPhone && (
                <a
                    ...
                    className="fixed bottom-8 right-8 z-50 flex items-center justify-center w-16 h-16 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95"
                    style={{ backgroundColor: '#25D366' }}
                    title={`Contactar a ${settings.businessName} por WhatsApp`}
                >
                    {/* Ping animation */}
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-8 h-8 relative z-10">
                        ...
                        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.126.554 4.122 1.524 5.855L.057 23.882a.5.5 0 00.611.611l6.027-1.467A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.907 0-3.693-.498-5.24-1.369l-.376-.217-3.896.948.947-3.896-.217-.376A9.956 9.956 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z" />
                    </svg>
                </a>
            )}
        </div>
