...
export const NotFoundPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center p-6 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#D4AF37]/5 blur-[150px] rounded-full -z-10" />
      ...
      <div className="max-w-2xl w-full text-center space-y-12 animate-entrance">
        <div className="relative inline-block">
          <div className="w-32 h-32 rounded-[2.5rem] bg-white/5 border border-white/10 flex items-center justify-center mx-auto shadow-2xl relative group overflow-hidden">
             <div className="absolute inset-0 bg-gradient-to-tr from-[#D4AF37]/10 to-[#AA7C11]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
        ...
        <div className="space-y-4">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-transparent via-[#D4AF37] to-transparent mx-auto mt-6" />
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8">
          <Link 
            to="/" 
            className="px-10 py-5 rounded-2xl bg-gradient-to-r from-[#D4AF37] to-[#AA7C11] text-black font-black text-[10px] uppercase tracking-widest shadow-lg shadow-[#D4AF37]/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center gap-3"
          >
