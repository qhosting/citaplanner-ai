          ...
          <form onSubmit={handleBooking} className="space-y-6">
            <div className="bg-zinc-900/40 p-10 rounded-[3rem] border border-white/5 shadow-sm space-y-8">
              ...
              <div className="border-t border-white/5 pt-8 space-y-6">
                {user?.exemptFromDeposit ? (
                  <div className="bg-[#D4AF37]/5 border border-[#D4AF37]/20 p-8 rounded-3xl text-center space-y-4 shadow-xl">
                    <div className="w-16 h-16 bg-[#D4AF37]/10 text-[#D4AF37] rounded-full flex items-center justify-center mx-auto border border-[#D4AF37]/20">
                      <ShieldCheck size={32} />
                    </div>
                    <div>
                      <h4 className="text-sm font-extrabold text-[#D4AF37] uppercase tracking-wider">Socio Preferente Aurum</h4>
                      <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider block mt-1">Exento de Anticipo</p>
                    </div>
                    <p className="text-[10.5px] text-zinc-400 font-semibold leading-relaxed uppercase tracking-wider max-w-md mx-auto">
                      Tu perfil técnico cuenta con una autorización de exención de pago. Puedes reservar y pre-confirmar tu cita de forma inmediata sin necesidad de transferir un anticipo ni subir un comprobante de pago.
                    </p>
                  </div>
                ) : (
                  <>
