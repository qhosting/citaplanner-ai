          ...
          <div className="hidden md:flex items-center gap-12">
            {[1, 2, 3, 4].map(i => (
              <div key={i} className="flex items-center gap-3">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-black border-2 transition-all duration-500 ${step >= i ? 'bg-slate-900 border-slate-900 text-white' : 'border-slate-100 text-slate-300'
                  }`}>
                  {i}
                </div>
