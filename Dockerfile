...
# REVISIÓN: 2026.10.18 (Security Core & Redis Layer)
...
# ADDED: Redis y JWT para la capa de seguridad y caché del backend.
RUN npm install --legacy-peer-deps && \
    npm install zod@3.24.1 react-hook-form@7.54.1 @hookform/resolvers@3.9.1 redis@4.6.13 jsonwebtoken@9.0.2 --legacy-peer-deps
...
# Aseguramos que los módulos de backend estén disponibles en el runner
