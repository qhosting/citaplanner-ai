...
# REVISIÓN: 2026.10.21 (Dependency Resolution Strategy: Prune & Copy)
...
# Usamos legacy-peer-deps para evitar bloqueos iniciales
...
# Ya no ejecutamos npm install aquí para evitar conflictos de resolución (ERESOLVE)
